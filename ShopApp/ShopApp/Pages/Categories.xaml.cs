...
namespace ShopApp.Pages
{
    ...
    public partial class Categories : ContentPage
    {
        ...
        private async void KategoriAc(object sender, EventArgs e)
        {
            ...
            {
                await TappedHome.instance.Navigation.PushAsync(new UrunListeleme(img.CategoryName));
            }
            else
            {
                await TappedHome.instance.Navigation.PushAsync(new AltCategories(img.CategoryName));
            }
        }
    }
}