...
namespace ShopApp.Pages
{
    ...
    public partial class AltCategories : ContentPage
    {
        string _categoryIsim;
        public AltCategories(string KategoriIsim)
        {
            InitializeComponent();
        ...
        private async void KategoriAc(object sender, EventArgs e)
        {
            ...
            {
                await TappedHome.instance.Navigation.PushAsync(new UrunListeleme(kategori.CategoryName));
            }
            else
            {
                await TappedHome.instance.Navigation.PushAsync(new AltCategories(kategori.CategoryName));
            }
        }
